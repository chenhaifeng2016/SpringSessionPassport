...
public class CustomerCookieSerializer implements CookieSerializer {
    ...
    public List<String> readCookieValues(HttpServletRequest request) {
        System.out.println("=================readCookieValues=================");
    ...
    public void writeCookieValue(CookieValue cookieValue) {
        System.out.println("=================writeCookieValue=================");
        ...
        sessionCookie.setMaxAge(980000);
    ...
    public void setJvmRoute(String jvmRoute) {
        ...
        System.out.println("jvmRoute = " + jvmRoute);
    }
